...
const NotFound = () => {
    return (
        <>
        <div class="bg-blue-100 border-t-4 mt-4 ml-12 mr-12 border-purple-500 rounded-b text-blue-400 px-4 py-3 shadow-md" role="alert">
            <div class="flex">
                ...
                <p class="text-sm">You are trying to reach out a page which is not defined.</p>
                </div>
            </div>
        </div>
        </>
